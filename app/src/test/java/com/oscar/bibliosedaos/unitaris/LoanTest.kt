...
class LoanTest {
    ...
    private class FakeApiSuccess : AuthApiService {
        ...
        override suspend fun getAllHoraris(): List<Horari> = emptyList()

        override suspend fun createHorari(horari: Horari): Horari = error("no utilitzat")

        override suspend fun getAllGrups(): List<Grup> = emptyList()

        override suspend fun createGrup(grup: Grup): Grup = error("no utilitzat")

        override suspend fun deleteGrup(id: Long): Response<ResponseBody> = error("no utilitzat")

        override suspend fun addMemberToGrup(grupId: Long, membreId: Long): Grup = error("no utilitzat")
    ...
    private class FakeApiError : AuthApiService {
        ...
        override suspend fun getAllHoraris(): List<Horari> = throw Exception("Error de xarxa")

        override suspend fun createHorari(horari: Horari): Horari = error("no utilitzat")

        override suspend fun getAllGrups(): List<Grup> = throw Exception("Error de xarxa")
